...
st.set_page_config(page_title="Iris Flower Classifier",page_icon="🌸",layouts="centered")
...
petal_width=st.number_input("Petal Width(cm)",min_value=0.0,max_value=10.0,value=0.2) st
